 ...
 * ---------------------------------------------------------------------------
 * The signature structural preset definitions. Data only; shared helpers and
 * chrome/deck/welcome constants live in structural-preset-data.ts, the public
 * API in structural-presets.ts.
 * ---------------------------------------------------------------------------
 */
